...
export const copy: Record<SupportedLocale, Copy> = {
  es: {
    pageTitle: "Comprobar una web — Vonü Check",
    pageDescription: "Pega una web o tienda online y revisa señales técnicas de riesgo antes de pagar o compartir datos.",
    eyebrow: "VONÜ CHECK · WEB",
    heading: "Comprueba antes de confiar.",
    subheading: "Pega una web o tienda online. Vonü revisa señales técnicas objetivas y te muestra qué merece atención.",
    ...
    noCertification: "Vonü no certifica que una web sea segura; te ayuda a detectar señales que conviene revisar antes de actuar.",
  },
  en: {
    pageTitle: "Check a website — Vonü Check",
    ...
    subheading: "Paste a website or online store. Vonü reviews objective technical signals and shows what deserves attention.",
    ...
    noCertification: "Vonü does not certify that a website is safe; it helps you spot signals worth reviewing before you act.",
  },
  fr: {
    pageTitle: "Vérifier un site — Vonü Check",
    ...
    subheading: "Collez un site ou une boutique. Vonü analyse des signaux techniques objectifs et montre ce qui mérite votre attention.",
    ...
    noCertification: "Vonü ne certifie pas qu’un site est sûr ; il aide à repérer les signaux à vérifier avant d’agir.",
  },
  de: {
    pageTitle: "Website prüfen — Vonü Check",
    ...
    subheading: "Füge eine Website oder einen Shop ein. Vonü prüft objektive technische Signale und zeigt, was Aufmerksamkeit verdient.",
    ...
    noCertification: "Vonü zertifiziert keine Website als sicher; es hilft, relevante Warnsignale vor einer Entscheidung zu erkennen.",
  },
  ar: {
    pageTitle: "تحقق من موقع — Vonü Check",
    ...
    subheading: "الصق موقعًا أو متجرًا إلكترونيًا. يفحص Vonü إشارات تقنية موضوعية ويعرض ما يستحق الانتباه.",
    ...
    noCertification: "لا يشهد Vonü بأن الموقع آمن؛ بل يساعدك على اكتشاف إشارات تستحق المراجعة قبل اتخاذ قرار.",
  },
};
