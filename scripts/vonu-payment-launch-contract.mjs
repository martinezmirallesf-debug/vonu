...
requireText(desktopFitCss, 'margin: 10px auto 12px !important;', "desktop URL real bottom gap");
requireText(desktopFitCss, 'margin-bottom: 10px !important;', "short desktop URL real bottom gap");
requireText(desktopFitCss, 'height: 234px !important;', "desktop URL reserves bottom gap height");
requireText(desktopFitCss, 'height: 214px !important;', "short desktop URL reserves bottom gap height");
