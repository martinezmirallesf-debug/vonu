...
const copy: Record<SupportedLocale, ContactCopy> = {
  es: {
    ...
    analyse: "Analizar con Vonü",
    reasons: [
      { title: "Soporte", text: "Cuenta, acceso, pagos, recargas o funcionamiento." },
      { title: "Producto", text: "Errores, ideas y sugerencias para mejorar Vonü." },
      { title: "Privacidad", text: "Datos, documentación, seguridad y uso responsable." },
      { title: "Colaboración", text: "Partners, medios y propuestas relacionadas con Vonü." },
    ],
    ...
    notes: ["No incluyas contraseñas, códigos ni datos bancarios completos.", "Si quieres comprobar una web, mensaje o captura sospechosa, usa directamente Vonü Check."],
  ...
  en: {
    ...
    write: "Write to us",
    analyse: "Analyse with Vonü",
    reasons: [
      { title: "Support", text: "Account, access, payments, packs or how Vonü works." },
      { title: "Product", text: "Bugs, ideas and suggestions to improve Vonü." },
    ...
    notes: ["Do not include passwords, codes or full banking details.", "If you want to check a suspicious website, message or screenshot, use Vonü Check directly."],
  ...
  fr: {
    ...
    write: "Nous écrire",
    analyse: "Analyser avec Vonü",
    reasons: [
      { title: "Support", text: "Compte, accès, paiements, packs ou fonctionnement." },
      { title: "Produit", text: "Bugs, idées et suggestions pour améliorer Vonü." },
    ...
    notes: ["N’incluez pas de mots de passe, codes ou coordonnées bancaires complètes.", "Pour vérifier un site, un message ou une capture suspecte, utilisez directement Vonü Check."],
  ...
  de: {
    ...
    analyse: "Mit Vonü analysieren",
    reasons: [
      { title: "Support", text: "Konto, Zugriff, Zahlungen, Pakete oder Funktionsweise." },
      { title: "Produkt", text: "Fehler, Ideen und Vorschläge zur Verbesserung von Vonü." },
    ...
    notes: ["Keine Passwörter, Codes oder vollständigen Bankdaten angeben.", "Wenn du eine verdächtige Website, Nachricht oder einen Screenshot prüfen willst, nutze direkt Vonü Check."],
  ...
  ar: {
    ...
    write: "اكتب لنا",
    analyse: "حلّل باستخدام Vonü",
    reasons: [
      { title: "الدعم", text: "الحساب أو الوصول أو المدفوعات أو حزم التحليل أو طريقة العمل." },
      { title: "المنتج", text: "الأخطاء والأفكار والاقتراحات لتحسين Vonü." },
    ...
    notes: ["لا تدرج كلمات مرور أو رموزًا أو بيانات بنكية كاملة.", "إذا كنت تريد فحص موقع أو رسالة أو لقطة شاشة مشبوهة، فاستخدم Vonü Check مباشرة."],
