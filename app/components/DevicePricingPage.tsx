...
const copy: Record<SupportedLocale, {
  ...
  es: {
    ...
    note: "Si borras los datos del navegador o cambias de dispositivo, Vonu puede no reconocer los análisis comprados. Conserva el recibo de Stripe por si necesitas soporte.",
    faqTitle: "Lo importante, claro.",
    faqs: [
      { q: "¿Tengo que crear una cuenta?", a: "No. Vonu Check funciona sin registro. El acceso se asocia de forma pseudónima al navegador/dispositivo." },
  ...
  en: {
    ...
    note: "If you clear browser data or switch device, Vonu may not recognise purchased analyses. Keep your Stripe receipt for support.", faqTitle: "Simple by design.",
    faqs: [
      { q: "Do I need an account?", a: "No. Vonu Check works without registration. Access is linked pseudonymously to the browser/device." },
  ...
  fr: {
    ...
    note: "Si vous effacez les données du navigateur ou changez d'appareil, Vonu peut ne plus reconnaître les analyses achetées. Conservez votre reçu Stripe.", faqTitle: "Simple et clair.",
    faqs: [
      { q: "Dois-je créer un compte ?", a: "Non. Vonu Check fonctionne sans inscription. L'accès est associé de manière pseudonyme au navigateur/appareil." },
  ...
  de: {
    ...
    note: "Wenn du Browserdaten löschst oder das Gerät wechselst, kann Vonu gekaufte Analysen eventuell nicht erkennen. Bewahre den Stripe-Beleg auf.", faqTitle: "Einfach und klar.",
    faqs: [
      { q: "Brauche ich ein Konto?", a: "Nein. Vonu Check funktioniert ohne Registrierung. Der Zugriff wird pseudonym mit dem Browser/Gerät verknüpft." },
  ...
  ar: {
    ...
    note: "إذا حذفت بيانات المتصفح أو غيرت الجهاز، قد لا يتعرف Vonu على التحليلات المشتراة. احتفظ بإيصال Stripe للدعم.", faqTitle: "واضح وبسيط.",
    faqs: [
      { q: "هل أحتاج إلى حساب؟", a: "لا. يعمل Vonu Check بدون تسجيل، ويرتبط الوصول بشكل مستعار بالمتصفح/الجهاز." },
