...
const copy: Record<SupportedLocale, SignupCopy> = {
  es: {
    ...
    cardMuted: "no ruido.",
    cardText: "Casos prácticos, cambios importantes en Vonü y recursos para comprobar antes de confiar, firmar o pagar.",
    ...
    ariaEmail: "Email para recibir recursos de Vonü",
    consentPrefix: "Quiero recibir recursos y novedades de Vonü. He leído la",
  ...
  en: {
    ...
    cardMuted: "not noise.",
    cardText: "Practical cases, important Vonü updates and resources that help you check before you trust, sign or pay.",
    ...
    ariaEmail: "Email to receive Vonü resources",
    consentPrefix: "I want to receive Vonü resources and updates. I have read the",
  ...
  fr: {
    ...
    cardText: "Des cas pratiques, les changements importants de Vonü et des ressources pour vérifier avant de faire confiance, signer ou payer.",
    ...
    ariaEmail: "Email pour recevoir les ressources Vonü",
    consentPrefix: "Je souhaite recevoir les ressources et nouveautés de Vonü. J’ai lu la",
  ...
  de: {
    ...
    cardText: "Praxisfälle, wichtige Vonü-Updates und Ressourcen zum Prüfen vor Vertrauen, Unterschrift oder Zahlung.",
    ...
    ariaEmail: "E-Mail für Vonü-Ressourcen",
    consentPrefix: "Ich möchte Vonü-Ressourcen und Updates erhalten. Ich habe die",
  ...
  ar: {
    ...
    cardText: "حالات عملية وتحديثات Vonü وموارد تساعدك على التحقق قبل الثقة أو التوقيع أو الدفع.",
    ...
    placeholder: "you@email.com",
    ariaEmail: "البريد الإلكتروني لتلقي موارد Vonü",
    consentPrefix: "أرغب في تلقي موارد وتحديثات Vonü وقد قرأت",
