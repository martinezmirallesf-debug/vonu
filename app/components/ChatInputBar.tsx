        ...
        <div className="w-full bg-transparent border-none shadow-none">
          <div className="relative w-full rounded-[22px] md:rounded-[20px] bg-white border border-zinc-200 px-2.5 pt-2 pb-2 shadow-[0_4px_16px_rgba(0,0,0,0.06)]">
            ...
            <textarea
              ...
              disabled={isTyping}
              rows={1}
              className="w-full resize-none overflow-y-auto bg-transparent outline-none text-[15px] text-zinc-900 placeholder:text-zinc-500 pl-[68px] pr-[88px] pt-3 pb-12 leading-6 min-h-[50px] max-h-[180px] md:pl-[66px]"
            />
