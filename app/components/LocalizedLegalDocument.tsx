  ...
  fr: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { title: "4. Intelligence artificielle", paragraphs: ["Les vérifications de texte, d’image ou de document PDF peuvent être traitées par des fournisseurs d’IA tels qu’OpenAI ou Google selon la fonction active. Vonu peut demander une analyse structurée des risques ou des points de révision documentaire et applique ensuite ses propres règles de calibration.", "Le résultat est une aide préventive et non une décision automatisée produisant des effets juridiques ou similaires sur l’utilisateur."] },
    ...
    terms: {
      ...
      sections: [
        ...
        { title: "2. Service", paragraphs: ["Vonu analyse messages, textes, captures, liens, sites et documents PDF. La révision documentaire peut organiser clauses, montants, dates, conditions de paiement et références de juridiction. Les scores sont des indices d’orientation, pas des probabilités mathématiques, certificats d’authenticité ou avis juridiques."] },
        { title: "3. Transparence de l’IA", paragraphs: ["Vonu utilise de l’intelligence artificielle et des vérifications automatisées susceptibles d’être incomplètes ou erronées. La langue d’un document ne détermine pas sa juridiction : Vonu tente de l’identifier à partir du document lui-même et peut rester incertain. Le résultat ne constitue pas un avis juridique et ne permet pas de conclure définitivement qu’une clause est valable, nulle, illicite ou exécutoire."] },
    ...
    "responsible-use": {
      ...
      updatedAt: UPDATED.fr,
      sections: [
        { title: "1. Rôle de Vonu", paragraphs: ["Vonu examine messages, captures, liens, sites et documents PDF afin de faire ressortir des signaux de risque ou des points à vérifier avant de faire confiance, répondre, partager des données, signer ou payer."] },
        { title: "2. Vous interagissez avec une IA", paragraphs: ["Vonu utilise de l’intelligence artificielle et des contrôles automatisés. L’IA peut mal comprendre le contexte ou produire une explication incorrecte. Pour les documents, la juridiction est recherchée dans le document lui-même et non déduite de sa langue. Le résultat est une orientation préventive, pas un verdict ni un avis juridique."] },
  ...
  de: {
    ...
    cookies: {
      ...
      sections: [
        ...
        { title: "3. Vercel Web Analytics", paragraphs: ["Vercel Web Analytics nutzt keine Third-Party-Analytics-Cookies und liefert aggregierte Messungen zu Seiten, Referrern, ungefährer Geolokalisierung, Browser, Betriebssystem, Gerät und Custom Events.", "Vonu vermeidet die Übermittlung von Roh-Nachricht, Screenshot, PDF-Inhalt oder extrahiertem Dokumenttext, E-Mail oder vollständiger analysierter URL als Analytics-Eigenschaft."] },
    ...
    "responsible-use": {
      ...
      updatedAt: UPDATED.de,
      sections: [
        { title: "1. Aufgabe von Vonu", paragraphs: ["Vonu prüft Nachrichten, Screenshots, Links, Websites und PDF-Dokumente, um Risikosignale oder Prüfpunkte vor Vertrauen, Antwort, Datenweitergabe, Unterschrift oder Zahlung sichtbar zu machen."] },
        { title: "2. Du interagierst mit KI", paragraphs: ["Vonu nutzt künstliche Intelligenz und automatisierte technische Prüfungen. KI kann Kontext falsch verstehen oder eine fehlerhafte Erklärung erzeugen. Bei Dokumenten wird die Rechtsordnung aus dem Dokument selbst und nicht aus seiner Sprache abgeleitet und kann unsicher bleiben. Das Ergebnis ist präventive Orientierung, kein Urteil oder Rechtsgutachten."] },
  ...
  ar: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { title: "2. البيانات التي قد نعالجها", items: ["محتوى الفحص: نصوص ورسائل ولقطات وصور وروابط ومستندات PDF والنص المستخرج منها والبيانات التي تحتويها.", "بيانات تقنية: نوع الفحص والإشارات ودرجة/فئة الخطر والمدة والحالة وبيانات عامة عن النطاق.", "معرّف عشوائي مستعار للمتصفح/الجهاز لإدارة الاستخدام المجاني والأرصدة المشتراة.", "بيانات التواصل أو النشرة التي ترسلها طوعاً.", "معرّفات الدفع والمعاملات من Stripe؛ لا يحتاج Vonu إلى حفظ رقم البطاقة الكامل.", "بيانات قياس مجمعة مثل الصفحات والمصدر والبلد/المنطقة التقريبية والمتصفح/الجهاز وأحداث المنتج."] },
        ...
        { title: "4. الذكاء الاصطناعي", paragraphs: ["قد تتم معالجة فحوص النصوص أو الصور أو مستندات PDF بواسطة مزودي ذكاء اصطناعي مثل OpenAI أو Google بحسب الوظيفة النشطة. ويمكن أن يطلب Vonu تحليلاً منظماً للمخاطر أو نقاط مراجعة المستند ثم يطبق قواعد المعايرة الخاصة به.", "النتيجة إرشاد وقائي وليست قراراً آلياً ينتج أثراً قانونياً أو أثراً مهماً مماثلاً على المستخدم."] },
    ...
    terms: {
      ...
      sections: [
        ...
        { title: "2. ما الذي يقدمه Vonu", paragraphs: ["يفحص Vonu الرسائل والنصوص واللقطات والروابط والمواقع ومستندات PDF. ويمكن لمراجعة المستندات تنظيم البنود والمبالغ والتواريخ وشروط الدفع وإشارات الولاية القضائية. الدرجات مؤشرات إرشادية وليست احتمالات رياضية أو شهادات أصالة أو آراء قانونية."] },
        { title: "3. شفافية الذكاء الاصطناعي", paragraphs: ["يستخدم Vonu الذكاء الاصطناعي وفحوصاً آلية قد تكون خاطئة أو غير مكتملة. لغة المستند لا تحدد ولايته القضائية؛ يحاول Vonu تحديدها من نص المستند نفسه وقد تبقى غير مؤكدة. النتيجة ليست استشارة قانونية ولا حكماً نهائياً بأن بنداً صحيح أو باطل أو غير قانوني أو قابل للتنفيذ."] },
    ...
    cookies: {
      ...
      sections: [
        ...
        { title: "3. Vercel Web Analytics", paragraphs: ["لا يعتمد Vercel Web Analytics على ملفات تحليلية من طرف ثالث، ويقدم قياسات مجمعة عن الصفحات والمصدر والموقع التقريبي والمتصفح ونظام التشغيل ونوع الجهاز والأحداث المخصصة.", "يضبط Vonu الأحداث لتجنب إرسال الرسالة الخام أو لقطة الشاشة أو محتوى PDF أو النص المستخرج من المستند أو البريد أو الرابط الكامل الذي تم تحليله كخاصية تحليلية."] },
    ...
    "responsible-use": {
      ...
      updatedAt: UPDATED.ar,
      sections: [
        { title: "1. دور Vonu", paragraphs: ["يفحص Vonu الرسائل واللقطات والروابط والمواقع ومستندات PDF لإظهار إشارات الخطر أو النقاط التي تستحق المراجعة قبل الثقة أو الرد أو مشاركة البيانات أو التوقيع أو الدفع."] },
        { title: "2. أنت تتفاعل مع ذكاء اصطناعي", paragraphs: ["يستخدم Vonu الذكاء الاصطناعي وفحوصاً تقنية آلية. قد يسيء الذكاء الاصطناعي فهم السياق أو ينتج تفسيراً غير صحيح. في المستندات تُستخلص الولاية القضائية من المستند نفسه لا من لغته وقد تبقى غير مؤكدة. النتيجة إرشاد وقائي وليست حكماً نهائياً أو رأياً قانونياً."] },
