        ...
        <div className="mx-auto grid max-w-[1500px] gap-6 px-4 py-14 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
          ...
          <div className="rounded-[36px] border border-zinc-200 bg-white p-4 shadow-[0_24px_70px_rgba(0,0,0,0.08)] sm:p-6">
            <form className="grid gap-4">
              ...
              <button
                type="button"
                className="inline-flex h-12 items-center justify-center gap-2 rounded-full bg-zinc-950 px-5 text-[15px] font-semibold text-white shadow-[0_12px_28px_rgba(0,0,0,0.16)] transition hover:scale-[1.01] active:scale-[0.99]"
              >
                Enviar mensaje
                <ArrowIcon />
              </button>

              <p className="text-center text-[12.5px] leading-5 text-zinc-400">
                Formulario visual preparado. La conexión de envío se activará en
                una fase posterior.
              </p>
            </form>
          </div>
