...
const checklist = [
  "Busca el nombre de la web fuera de su propia página.",
...
const commonCases = [
  ...
  {
    title: "Web de redes sociales o anuncio",
...
function WarningTitle({ title }: { title: string }) {
  if (title === "Descuento demasiado agresivo") {
    return (
      <>
        Descuento demasiado
        <span className="block">
          <GradientText tone="orangeRed">agresivo</GradientText>
        </span>
      </>
    );
  }

  if (title === "Pago con poca protección") {
    return (
      <>
        Pago con poca
        <span className="block">
          <GradientText tone="amberOrange">protección</GradientText>
        </span>
      </>
    );
  }

  if (title === "Datos legales confusos") {
    return (
      <>
        Datos legales
        <span className="block">
          <GradientText tone="blueCyan">confusos</GradientText>
        </span>
      </>
    );
  }

  if (title === "Dominio extraño o reciente") {
    return (
      <>
        Dominio extraño
        <span className="block">
          o <GradientText tone="purplePink">reciente</GradientText>
        </span>
      </>
    );
  }

  if (title === "Opiniones poco naturales") {
    return (
      <>
        Opiniones poco
        <span className="block">
          <GradientText tone="green">naturales</GradientText>
        </span>
      </>
    );
  }

  if (title === "Presión para decidir rápido") {
    return (
      <>
        Presión para
        <span className="block">
          decidir <GradientText tone="orangeRed">rápido</GradientText>
        </span>
      </>
    );
  }
...
function CommonCaseTitle({ title }: { title: string }) {
  if (title === "Tienda con descuentos enormes") {
    return (
      <>
        Tienda con{" "}
  ...
  if (title === "Pago solo por transferencia") {
    return (
      <>
        Pago solo por <GradientText tone="amberOrange">transferencia</GradientText>
      </>
    );
  }

  if (title === "Web parecida a una marca conocida") {
    return (
      <>
        Web parecida a una{" "}
        <GradientText tone="blueCyan">marca conocida</GradientText>
      </>
    );
  }

  if (title === "Web de redes sociales o anuncio") {
    return (
      <>
        Web de redes sociales o{" "}
              ...
              <div>
                ...
                <h2 className="mt-4 text-[44px] font-semibold leading-[1.06] tracking-[-0.058em] sm:leading-[0.98] sm:tracking-[-0.065em] text-zinc-950 sm:text-[72px]">
                  ...
                  <span className="block text-zinc-500">
                    <GradientText tone="orangeRed">revísalo.</GradientText>
                  </span>
                </h2>
          ...
          <div className="mb-10 flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <div>
              ...
              <h2 className="mt-3 max-w-3xl text-[44px] font-semibold leading-[1.06] tracking-[-0.058em] sm:leading-[0.98] sm:tracking-[-0.065em] text-zinc-950 sm:text-[72px]">
                Pistas de una web
                <span className="block text-zinc-500">
                  o tienda <GradientText tone="orangeRed">poco fiable.</GradientText>
                </span>
              </h2>
            </div>
          ...
          <div>
            ...
            <h2 className="mt-3 max-w-3xl text-[44px] font-semibold leading-[0.96] tracking-[-0.065em] sm:text-[72px]">
              ...
              <span className="block text-zinc-400">
                siguen patrones <GradientText tone="blueCyan">parecidos.</GradientText>
              </span>
            </h2>
          ...
          <div className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr]">
            <div>
              ...
              <h2 className="mt-3 max-w-3xl text-[44px] font-semibold leading-[1.06] tracking-[-0.058em] sm:leading-[0.98] sm:tracking-[-0.065em] text-zinc-950 sm:text-[72px]">
                El diseño bonito
                <span className="block text-zinc-500">
                  no garantiza que sea <GradientText tone="purplePink">segura.</GradientText>
                </span>
              </h2>
        ...
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="mb-10 text-center">
            ...
            <h2 className="mx-auto mt-3 max-w-3xl text-[54px] font-semibold leading-[0.9] tracking-[-0.075em] text-zinc-950 sm:text-[82px]">
              Dudas sobre
              <span className="block text-zinc-500">webs fiables</span>
            </h2>
          </div>
