...
const UI: Record<SupportedLocale, UiCopy> = {
  es: {
    ...
    confidence: "Cobertura del análisis",
    limited: "Parcial",
    medium: "Estándar",
    highConfidence: "Amplia",
  ...
  fr: {
    ...
    confidence: "Couverture de l’analyse",
    limited: "Partielle",
    medium: "Standard",
    highConfidence: "Étendue",
  ...
  de: {
    ...
    confidence: "Analyseumfang",
    limited: "Teilweise",
    medium: "Standard",
    highConfidence: "Umfassend",
