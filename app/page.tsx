...
>
  ...
  className="h-10 w-10 rounded-full grid place-items-center text-zinc-450 active:bg-zinc-200/70 transition-colors"
>
        <svg
...
<path d="M5 18.5h14" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" />
  ...
  <div className="text-[10.5px] leading-4 text-zinc-450 md:hidden">
    Orientación preventiva · No sustituye profesionales.
  </div>
) : null}
  </div>
